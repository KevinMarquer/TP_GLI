package interactiveCamembert.view;
...
import interactiveCamembert.controle.ControleurIC;
...
public class CamembertView extends JComponent implements MouseListener,
	...
	static ControleurIC controller;
	...
	public CamembertView(Adaptateur m) {
		model = m;
		startingAngle = 0.0;
	...
	public void setController(ControleurIC c) {
		controller = c;
	}
				...
				if (i == controller.getSelectedPie()) {
					...
					if (y < pieCenter.getY()) {
						if (x > pieCenter.getX()) { // top right
							...
							g2d.drawString("" + (float)model.getValues(i) + " "
